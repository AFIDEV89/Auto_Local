                          ...
                          products.list.map((product, i) => {
                            ...
                            return (
                              <Col
                                ...
                                xl={4}
                                xxl={4}
                                className="product-slider-column"
                                ...
                                <Box className="product-slider">
                                  <Card>
                                    <Box className="thumbnail-wrapper">
                                      ...
                                      <CardImg
                                        src={picture || imageNotAvailable}
                                        alt={picture ? product?.name : "empty-product"}
                                        loading='lazy'
                                        height="240"
                                      />
                                    ...
                                    <CardBody className="d-flex flex-column justify-content-around">
                                      <Link
                                        ...
                                        to={`${ROUTES.PRODUCT}/${product.seo_canonical || product.id}`}>
                                        {product?.name}
                                      </Link>

                                      <Colors product={product} />
                                      <div onClick={(event) => event.stopPropagation()} className="align-self-end">
                                        <Button style={{ backgroundColor: '#F5B100', borderColor: '#F5B100', color: 'white' }} onClick={() => showShopNowModal(product)} >Shop Now</Button>
                                      </div>
                                    </CardBody>

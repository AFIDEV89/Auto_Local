...
export function filterProducts(filter) {
    return async () => {
        try {
            const response = await axios.post(`${base_url}/api/products/filter`, filter );
...
export function getProduct(id) {
    return async () => {
        try {
            const response = await axios.post(`${base_url}/api/product/details`, { id });
...
export function getRelatedProducts(id) {
    return async () => {
        try {
            const response = await axios.post(`${base_url}/api/product/related`, { id });
...
export function getProductReviews() {
    return async () => {
        try {
            const response = await axios.get(`${base_url}/api/review/list`);
